# this file contains some constitutive functions for the compaction problem solver
import numpy as np
...
def sat(T):
     # ice saturation S as a function of undercooling temperature T
     f = 1 - abs(1/(1+T))**b 
...
def D(phi,S,eps=1e-10):
     # diffusivity in advection-diffusion problem
     k = perm(S)
     d = ((1-phi*S)**2)/ k
     return (1-phi)/d +  eps
...
def Phi_lens(z):
    # porosity beneath the ice lens as a function of lens position
